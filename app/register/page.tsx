...
export default function RegisterPage() {
  ...
  return (
    <main style={{ padding: "30px 20px", maxWidth: "400px", margin: "0 auto" }}>
      ...
      <p style={{ color: "var(--muted)", fontSize: "14px", marginBottom: "24px", textAlign: "center" }}>アンケートにご協力ください</p>

      {/* 来場手段（複数回答可） */}
      <div style={{ marginBottom: "24px" }}>
        <label style={{ fontWeight: "bold", fontSize: "15px", display: "block", marginBottom: "10px" }}>
          来場手段（複数回答可）
        </label>
            ...
            return (
              <div key={opt.value} onClick={() => toggleTransport(opt.value)}
                style={{
                  padding: "12px 16px",
                  borderRadius: "8px",
                  border: checked ? "2px solid #e10102" : "1px solid var(--card-border)",
                  backgroundColor: checked ? "rgba(225,1,2,0.08)" : "var(--card-bg)",
                  cursor: "pointer",
                  display: "flex",
                  alignItems: "center",
                  gap: "10px",
                ...
                <span style={{
                  ...
                  height: "20px",
                  borderRadius: "4px",
                  border: checked ? "none" : "2px solid var(--card-border)",
                  backgroundColor: checked ? "#e10102" : "transparent",
                  display: "flex",
                  alignItems: "center",
            ...
            return (
              <div key={opt.value} onClick={() => setGender(opt.value)}
                style={{
                  padding: "12px",
                  borderRadius: "8px",
                  border: selected ? "2px solid #e10102" : "1px solid var(--card-border)",
