  ...
  return (
    <div style={{ padding: "20px", maxWidth: "500px" }}>
      ...
      <div style={{ display: "flex", gap: "8px", marginBottom: "20px" }}>
        ...
        />
        <button onClick={addClass} style={{ padding: "8px 16px", fontSize: "15px", cursor: "pointer" }}>
          追加
        </button>
      </div>
      ...
      <ul style={{ listStyle: "none", padding: 0 }}>
        {classes.map((c) => (
          <li key={c.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 12px", borderBottom: "1px solid #eee" }}>
            ...
            <button onClick={() => deleteClass(c.id)} style={{ color: "#f44336", background: "none", border: "none", cursor: "pointer", fontSize: "14px" }}>
              削除
            </button>
          </li>
        ))}
